...
namespace CartoonFX
{
    ...
    public class CFXR_ParticleText : MonoBehaviour
    {
        ...
        [SerializeField]
        private Color color1 = new(1, 1, 1, 1);

        [SerializeField]
        private Color color2 = new(0, 0, 1, 1);

        [Header("Delay"), SerializeField]
        
        private float delay = 0.05f;

        [SerializeField]
        private bool cumulativeDelay = false;

        [Range(0f, 2f), SerializeField] 
        private float compensateLifetime = 0;
    ...
    #pragma warning restore 0649
        ...
        )
        {
            ...
            if (newText != null)
            {
                ...
                foreach (char c in newText)
                {
                    ...
                    {
                        throw new Exception("[CFXR_ParticleText] Invalid character supplied for the dynamic text: '" +
        ...
        private bool autoUpdateEditor = true;
    ...
    {
        private GUIContent GUIContent_AutoUpdateToggle =
            new("Auto-update", "Automatically regenerate the text when a property is changed.");

        private GUIContent GUIContent_UpdateTextButton = new(" Update Text ",
